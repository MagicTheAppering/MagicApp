...
namespace Magic.Droid.Examples.CameraControl
{
    ...
    public class CameraControlActivity : Activity, View.IOnTouchListener, CameraBridgeViewBase.ICvCameraViewListener2
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.CameraControl);

            mOpenCvCameraView = FindViewById<CameraControlView>(Resource.Id.CamControlView);
