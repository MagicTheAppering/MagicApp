...
namespace Magic.Droid.Examples.Manipulation
{
    ...
    public class ImageManipulationsActivity : Activity, CameraBridgeViewBase.ICvCameraViewListener2
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.ImageManipulation);

            mOpenCvCameraView = FindViewById<CameraBridgeViewBase>(Resource.Id.ManipulationView);
